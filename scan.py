...
def vulnerable(response):
    errors = {"alıntılanan string düzgün şekilde sonlandırılamadı",
              "karakter dizesinded sonra kapatılmamış tırnak işareti",
              "SQL Syntaxınızda bir hata var"
              }
    for error in errors:
...
def sql_injection_scan(url):
    ...
    for i in "\"'":
        ...
        if vulnerable(res):
            ...
            print("SQL Injection saldırısı güvenlik açığı algılanmadı")
            break

if __name__ == "__main__":
    urlToBeChecked = "https://www.btkakademi.gov.tr/"
